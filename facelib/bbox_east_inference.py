# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/05_bbox_east_inference.ipynb (unless otherwise specified).

__all__ = ['TextBBoxPredictor', 'resize_one_img', 'bboxes_on_image', 'show_bboxes_on_image']
...
from .face_east_training import *
from .face_east_training import east_config
from .face_east_training import create_grid
